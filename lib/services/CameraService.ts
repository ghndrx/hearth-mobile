...
// Video quality presets for optimized compression
...
export type VideoQualityPreset = keyof typeof VideoQualityPresets;
...
export class CameraService {
  ...
  async startVideoRecording(
    ...
    try {
      // Use quality preset for optimized compression
      const preset = VideoQualityPresets[options.quality || 'medium'];
      
      const recordingOptions = {
        quality: preset ? 'medium' : 'high', // expo-camera quality level
